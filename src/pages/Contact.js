...
const Contact = () => {
	return (
		<div class="p-20">
			<div className="experienceHeader"><b>Contact Me</b></div>
			<div class="container">
				<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
					<div class="contact-left">
						<p class="flex items-center">
							<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-send mr-2" viewBox="0 0 16 16">
					...
					<div class="contact-right">
						<form method="POST" action="https://script.google.com/macros/s/AKfycbyq-E7WOFMmrPK13YxiN2wztnVvg8rhRhVYy6B7e-BcNgDQ8Bbk74IoP_PS0yfO5E2law/exec" id="myForm">
							<input type="text" name="name" placeholder="Your Name" required class="w-full p-2 mb-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-honey-500"></input>
							<input type="email" name="email" placeholder="Your Email" required class="w-full p-2 mb-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-honey-500"></input>
							<textarea name="message" rows="6" placeholder="Your Message" class="w-full p-2 mb-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-honey-500"></textarea>
							<button type="submit" class="bg-honey text-white py-2 px-4 rounded hover:bg-honey-600 focus:outline-none">Submit</button>
						</form>
						<span id="msg"></span>
					</div>
				</div>
